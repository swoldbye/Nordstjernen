...
public class EtapeListAdapter extends RecyclerView.Adapter<EtapeListAdapter.EtapeListViewHolder> {
    ...
    public EtapeListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if( viewType == 0 ){
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.etapeoversigt_card_destination, parent, false);
            viewHolder = new EtapeListViewHolder(view, false);
        }else{
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.etapeoversigt_card_etape, parent, false);
